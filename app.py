...
DISPLAY_NAMES = {
    'file1_name': 'File 1',
    'file2_name': 'File 2',
    'failed_file1_only': 'Cases Failed only in {file1_name}',
    'failed_file2_only': 'Cases Failed only in {file2_name}',
    'failed_both': 'Cases Failed in both files',
...
def compare_test_results_as_tables(file1_path, file2_path, custom_label1=None, custom_label2=None):
   ...
   #  print(f"Reading file 2: {file2_path}")
    ...
    result_tables = {
        ...
        'failed_both': df1_copy[df1_copy[case_id_col1].isin(fail_in_both_ids)][display_cols1],
...
def find_tested_by_column(df):
    ...
    possible_names = ["tested by", "testedby", "tested", "tester", "assigned to", "assignedto", "executor"]
